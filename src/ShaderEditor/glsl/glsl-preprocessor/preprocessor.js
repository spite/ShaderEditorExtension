var preProcessShader = (function() {
    ...
    var preProcessor = function(source, doReplaceDefine, doPruneComment) {
        ...
        // what we'll do
        var pruneComment = doPruneComment !== undefined ? doPruneComment : true;
        var pruneDefines = true;
        var addNewLines = true;
        var replaceDefine = doReplaceDefine !== undefined ? doReplaceDefine : true;
